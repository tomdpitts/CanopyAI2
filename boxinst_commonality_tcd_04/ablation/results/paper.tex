...
value sits in the column matching the protocol it was measured under.}
\label{tab:oamtcd439}
...
\midrule\\
Restor Mask R-CNN\tnote{b} & masks & 4169 & & & 0.432 & & \\
DetecTree2 (fine-tuned) & masks & 900 & 0.535 & 0.224 & 0.421 & 0.180 & 0.529 \\
\addlinespace[2pt]
SelvaBox $\rightarrow$ SAM 3 (both FT)\tnote{a} & box + ext + SAM & $\sim$3335
  & & 0.185 & & & \\
SelvaBox $\rightarrow$ SAM 3 (frozen SAM)\tnote{a} & box + SAM & $\sim$3335
  & & 0.122 & & & \\
\textbf{LACE (ours)} (3-seed) & box + ign\tnote{c} & 900
...
\item[a] \emph{Imgs}\,=\,number of OAM-TCD training images seen. 
